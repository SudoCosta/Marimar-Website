...
export const metadata: Metadata = {
  title: "Higienização e Engomadoria ao Domicílio em Leiria",
  description: "Conheça os serviços e preços Marimar para sofás, colchões, carpetes, tapetes, estofos e engomadoria ao domicílio em Leiria.",
  ...
  return (
    <main id="conteudo">
      <section className="page-hero page-hero-split">
        ...
        <div className="page-hero-aside"><p>A Marimar trabalha estofos e superfícies têxteis com uma abordagem ajustada à peça, ao estado e ao contexto em que será realizado o serviço.</p><ul className="mini-checks"><li><Check aria-hidden="true" />Valores de referência disponíveis</li><li><Check aria-hidden="true" />Um pedido pode incluir várias categorias</li><li><Check aria-hidden="true" />Não precisa de saber o material exato</li></ul></div>
      </section>
