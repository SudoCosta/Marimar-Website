...
import { ArrowUpRight, Camera, Mail, MessageCircle, Phone } from "lucide-react";
      ...
      <section className="page-hero page-hero-split contact-hero">
        ...
        <aside className="contact-panel">
          ...
          {hasContacts ? <div className="contact-options">
            ...
            {contacts.instagram && <a href={contacts.instagram} target="_blank" rel="noreferrer"><Camera aria-hidden="true" /><span><small>Instagram</small>@marimar.limpeza</span></a>}
